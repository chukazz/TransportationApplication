...
namespace Data.DataAccess.Migrations
{
    ...
    [Migration("20200729151924_v0.1.6-AddHowItWorks")]
    partial class v016AddHowItWorks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Model.HowItWorks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Data.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ActivationCode = 0,
                            CreateDateTime = new DateTime(2020, 7, 29, 19, 49, 24, 182, DateTimeKind.Local).AddTicks(4154),
                            EmailAddress = "abolfazl.sh1374@gmail.com",
                            IsDeleted = false,
                            IsEnabled = true,
                            IterationCount = 6247,
                            Name = "Developer",
                            Password = "01B25371C55AFC90F3C319DE555EDD7AE1B4710745847C8AC26864A04705F9E99885E49CFD55E9031F9C8E2622E6C096F92FCEFFFAF7A1533AD1FAC250E6AAE3",
                            Salt = new byte[] { 108, 229, 126, 172, 231, 64, 100, 227, 191, 139, 126, 89, 148, 15, 221, 178, 204, 85, 41, 147, 149, 103, 90, 122, 133, 106, 199, 9, 9, 154, 60, 40 },
                            SerialNumber = "c0455ea8-688a-4803-8adf-253a18c8865e"
                        });
                });
